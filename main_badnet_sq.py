...
if __name__ == "__main__":
    ...
    # args.teacher_architecture="cifar_resnet18"
    # args.student_architecture="cifar_resnet18"
    args.teacher_architecture="preactresnet18"
    # args.teacher_architecture="WRN-16-2"
    #args.student_architecture="WRN-16-1"
    args.student_architecture="preactresnet18"
    
    # args.trigger_pattern= 'badnet_grid'
    args.trigger_pattern= 'badnet_sq'
    # 'sig'
    # 'smooth'
    # 'l0_inv'
    # args.shuf_teacher = 0.1
    #   # - 0.
    # args.pseudo_test_batches = 0.
    # args.trigger_pattern= "blend"
    args.seed = 3
    #todo
