...
def dataset_and_transform_generate(args):
    ...
    if (train_dataset_without_transform is None) or (test_dataset_without_transform is None):
        ...
        if args.dataset.startswith('test'):  # for test only
            ...
            ##todo normalization for cifar10
            ...
            train_dataset_without_transform = GTSRB('/home/ztb/benchnew/data/gtsrb',
                                                    train=True,
                                                    )
            test_dataset_without_transform = GTSRB('/home/ztb/benchnew/data/gtsrb',
                                                   train=False,
                                                   )
